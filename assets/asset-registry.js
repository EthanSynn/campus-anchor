(function () {
  const registry = {
    "character.male.master": { asset_id: "character.male.master", role: "master-character", path: "male-ai-master-v1.0.0.png", version: "1.0.0", status: "approved" },
    "character.female.master": { asset_id: "character.female.master", role: "master-character", path: "female-ai-master-v1.0.0.png", version: "1.0.0", status: "approved" }
  };
  function get(assetId) { return registry[assetId] || null; }
